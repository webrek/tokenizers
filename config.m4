...
if test "$PHP_TOKENIZERS" != "no"; then
  ...
  PHP_NEW_EXTENSION(tokenizers,
    [tokenizers.c src/model.c src/base64.c src/heap.c src/engine.c src/pretok.c src/loader_tiktoken.c src/cache.c src/bpe_class.c src/normalize.c src/wordpiece.c],
